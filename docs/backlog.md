...
> - ⬜ **PDF-EXTRACT-2 (restos)**: importes de la furgoneta escaneada (OCR ruidoso) · nº/fecha de SH (el QR se come esa zona en OCR) · nº SOLRED marzo (coge una fecha) · proveedor/base de "factura benjamin A-024" y HMNOS ARENAS · fecha de Forjados (coge la del albarán; la real va como "24-mar.-2026").
