...
- ⬜ Todavia no tenemos la generacion del pdf, ni importaciones en los modulos donde se van a usar esas funciones, ya que CONTENDO usa IA, nosotros lo vamos a hacer con dependencias OCR y Regex, sin usar IA.
