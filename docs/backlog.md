...
> **Última actualización: 2026-07-12 (sesión maratón) — v0.1.35 PUBLICADA (F1-WINSVC servicio Windows + F1-INSTVAR MSI Asesoría/Puesto, verificado con reinicio real). v0.1.36 CONSTRUIDA pero NO PUBLICADA (MSI ya en dist/msi): lleva FAC-CLIVAL + VF3-XML, EN ESPERA hasta meter Tema 2 (factura PDF emitida en Facturación) y Tema 1 (compensación de facturas, bloque COMP-) que Benjamin quiere en la MISMA versión. Cuadre 130 RESUELTO (era error de la asesoría, BENJAGEST bien).**
>
