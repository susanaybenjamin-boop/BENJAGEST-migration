...
> **Última actualización: 2026-07-11 (mañana) — F1-BANCO-CUENTA + F1-BANCO-REVIEW: alta de cuenta bancaria + conciliación por REVISIÓN (checkbox + pago existente debajo). RELEASE v0.1.33.**
>
> ## 🚀 PROMPT PARA LA PRÓXIMA SESIÓN (copiar y pegar)
>
> *"Lee la cabecera de docs/backlog.md y docs/plan-estructural-fases.md. Estamos en la FASE 1 del plan estructural (v0.1.33 publicada). Pendientes en orden: (1) **probar en la app v0.1.33 la conciliación bancaria**: Bancos → Nueva cuenta → Importar Excel BBVA → pantalla de REVISIÓN (marcar pendientes, ver el pago existente colgando en los ya pagados, Conciliar seleccionados) — smoke VISUAL que quedó pendiente; (2) **cuadre 130 2T con la asesoría** — BENJAGEST da pago 693,36 con la nómina de Rubén ya dentro; a la asesoría le sobran +580 de ingresos (¿abono no restado?) y ~1.477 de gastos (¿duplicado Los Llanos suyo, IVA no deducible, RETA?); (3) **F1-WINSVC + F1-INSTVAR** conmigo delante (servicio Windows + 2 instaladores); (4) **VF3-CERT** cuando quiera Benjamin — su certificado FNMT ya está localizado; (5) F1-XDIARIO sigue aparcado sin fichero de referencia. Gotchas: pin-login entra como la ASESORÍA — para la empresa de Benjamin usar X-Company-Id ad9cb9e6-51bd-4556-8c54-a6f1ecc028d5; no tocar 8080/13307 con su app abierta; smokes con user.home FUERA del repo y de Temp (arranque embebido con -Duser.home=C:/Proyectos/smoke-home)."*
>
