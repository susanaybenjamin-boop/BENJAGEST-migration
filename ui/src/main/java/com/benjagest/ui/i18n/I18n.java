...
public final class I18n {
    ...
    public static String t(Language lang, String key) {
        if (lang == Language.EN) {
            ...
            case "tax.filings.action.delete" -> "Delete";
                ...
                case "aeat111.recalc" -> "Recalculate from payroll";
                case "aeat111.section.trabajo" -> "I. Employment income";
                case "aeat111.section.actividades" -> "II. Business/professional income";
                case "aeat111.perceptores" -> "No. of recipients";
                case "aeat111.percepciones" -> "Amount of payments";
                case "aeat111.retenciones" -> "Amount withheld";
                case "aeat111.total" -> "Result to pay (box 30):";
                case "aeat111.hint" -> "IRPF withholdings for the quarter. Employment income is taken from the quarter's payslips; professional income from received invoices with withholding. When marked as PAID, the 4751 → bank entry clears the accrued withholding.";
    ...
    static String tEs(String key) {
        return switch (key) {
            ...
            case "aeat111.recalc" -> "Recalcular desde nóminas";
            case "aeat111.section.trabajo" -> "I. Rendimientos del trabajo";
            case "aeat111.section.actividades" -> "II. Actividades económicas";
            case "aeat111.perceptores" -> "Nº de perceptores";
            case "aeat111.percepciones" -> "Importe de las percepciones";
            case "aeat111.retenciones" -> "Importe de las retenciones";
            case "aeat111.total" -> "Resultado a ingresar (casilla 30):";
            case "aeat111.hint" -> "Retenciones de IRPF del trimestre. El trabajo se toma de las nóminas del periodo; las actividades, de las facturas recibidas con retención. Al marcarlo PAGADO, el asiento 4751 → banco vacía la retención acumulada.";
    ...
    static String tSessionEn(String key) {
        return switch (key) {
            ...
            case "trabajos.footer.total" -> "Shown total: {total} · pending {pending} · {n} job(s)";
            case "trabajos.col.pending" -> "Pending";
            case "trabajos.col.total" -> "Total";
            case "trabajos.group.no_customer" -> "No customer";
            case "trabajos.group.jobs" -> "{n} job(s)";
    ...
    static String tSessionEs(String key) {
        return switch (key) {
            ...
            case "trabajos.footer.total" -> "Total mostrado: {total} · pendiente {pending} · {n} trabajo(s)";
            case "trabajos.col.pending" -> "Pendiente";
            case "trabajos.col.total" -> "Total";
            case "trabajos.group.no_customer" -> "Sin cliente";
            case "trabajos.group.jobs" -> "{n} trabajo(s)";
    ...
    static String tNewModulesEn(String key) {
        return switch (key) {
            ...
            case "labor.payslips.action.ss" -> "Social Security";
            case "labor.ss.title" -> "Social Security settlement";
            case "labor.ss.pay_hint" -> "Monthly Social Security due to the TGSS (employer + employee), from the payroll contributions. Paying a month books the 476 -> bank entry that clears the accrued amount. \"Pay all pending\" settles every unbooked month at once.";
            case "labor.ss.empty" -> "No Social Security contributions for this year.";
            case "labor.ss.col.month" -> "Month";
            case "labor.ss.status.paid" -> "Paid";
            case "labor.ss.status.pending" -> "Pending";
            case "labor.ss.pay" -> "Pay month";
            case "labor.ss.pay_all" -> "Pay all pending";
            case "labor.ss.paid_n" -> "{n} month(s) settled.";
    ...
    static String tNewModulesEs(String key) {
        return switch (key) {
            ...
            case "labor.payslips.action.ss" -> "Seguros Sociales";
            case "labor.ss.title" -> "Liquidación de Seguridad Social";
            case "labor.ss.pay_hint" -> "Cuota mensual de Seguridad Social a la TGSS (empresa + trabajador), calculada desde las cotizaciones de las nóminas. Pagar un mes genera el asiento 476 -> banco que salda la cuota. \"Pagar todos los pendientes\" liquida de una vez los meses sin asiento.";
            case "labor.ss.empty" -> "No hay cotizaciones de Seguridad Social en este año.";
            case "labor.ss.col.month" -> "Mes";
            case "labor.ss.status.paid" -> "Pagada";
            case "labor.ss.status.pending" -> "Pendiente";
            case "labor.ss.pay" -> "Pagar mes";
            case "labor.ss.pay_all" -> "Pagar todos los pendientes";
            case "labor.ss.paid_n" -> "{n} mes(es) liquidados.";
