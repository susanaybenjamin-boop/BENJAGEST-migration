...
public final class I18n {
    ...
    static String tAdvisoryInvitationsEn(String key) {
        return switch (key) {
            ...
            case "bank.import.done_body" -> "{total} rows: {imported} imported, {skipped} skipped, {matched} auto-reconciled.";
    ...
    static String tAdvisoryInvitationsEs(String key) {
        return switch (key) {
            ...
            case "bank.import.done_body" -> "{total} filas: {imported} importadas, {skipped} ya existían, {matched} conciliadas automáticamente.";
